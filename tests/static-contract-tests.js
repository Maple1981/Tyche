...
assert("Visible reading blocks expose practical conclusions", ["publicProjectionConclusion", "supportConclusion", "tensionConclusion", "triplicityFoundationConclusion", "lotPracticalConclusion"].every((name) => app.includes(`function ${name}`)));
