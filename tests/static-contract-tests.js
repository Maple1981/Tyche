...
assert("Main lots audit separates view model from HTML rendering", app.includes("function buildMainLotsAuditModel(chart)") && app.includes("function renderMainLotAuditRow(row)") && mainLotsAuditBlock.indexOf("buildMainLotsAuditModel(chart)") < mainLotsAuditBlock.indexOf("renderMainLotsAudit(chart)") && sectionBetween(app, "function renderMainLotsAudit(chart)", "function renderInterpretationBlock(block)").includes("model.rows.map(renderMainLotAuditRow)"));
